  ...
  Future<ApiResponse<List<PostModel>, String>> fetchPosts() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ApiResponse.error("Failed to load posts", headers: response.headers.map((key, value) => MapEntry(key, [value])));
      }
    } catch (e) {
      return ApiResponse.error("Error fetching posts: $e");
    }
  }
}
